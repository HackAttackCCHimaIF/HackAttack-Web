      ...
      <div className="w-[95%] mx-auto px-1">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10">
          ...
          <div className="flex flex-col gap-5 w-full md:max-w-md">
            ...
            <motion.div whileHover={{ y: -1, scale: 1.03 }} transition={{ type: "spring", stiffness: 300 }}>
              <Link href="/" className=" text-neutral-200">Home</Link>
            </motion.div>
            <motion.div whileHover={{ y: -1, scale: 1.03 }} transition={{ type: "spring", stiffness: 300 }}>
              <Link href="/contact" className=" text-neutral-200">Contact us</Link>
            </motion.div>
            </div>
        ...
        <div className="mt-12 border-t border-neutral-800 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4  h-full">
          ...
          <div className="flex items-center gap-4">
            <motion.div whileHover={{ y: -1, scale: 1.03 }} transition={{ type: "spring", stiffness: 300 }}>
              <Link href="#" aria-label="Instagram" className="text-neutral-400 hover:text-white transition">
                <InstagramLogo size={20} />
              </Link>
            </motion.div>
            <motion.div whileHover={{ y: -1, scale: 1.03 }} transition={{ type: "spring", stiffness: 300 }}>
              <Link href="#" aria-label="LinkedIn" className="text-neutral-400 hover:text-white transition">
