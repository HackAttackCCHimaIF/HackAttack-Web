    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className='px-4 sm:px-8 lg:px-16 z-10 relative'>
        ...
        <div className="w-full min-h-screen row-span-9 lg:grid-rows-3 lg:min-h-[75vh] mb-8 mt-32 grid grid-cols-3 md:grid-cols-5 lg:grid-cols-10 gap-4 z-10 relative">
                {/* Item 1 */}
                <div className="col-span-2 relative md:col-span-3 lg:col-span-4 row-span-3 lg:row-span-3 bg-[#BA4300]/20 backdrop-blur-md rounded-3xl border border-white/20">
                ...
                {/* Item 2 */}
                <div className="col-span-1 md:col-span-2 relative lg:col-span-2 row-span-3 lg:row-span-2 bg-[#0F75BD]/20 backdrop-blur-md rounded-3xl border border-white/20">
                    {/* Content */}
                ...
                {/* Item 3 */}
                <div className="col-span-3 md:col-span-5 relative lg:col-span-4 lg:row-span-1 row-span-2 bg-[#C7A7BC]/10 backdrop-blur-md rounded-3xl border border-white/20">
                    {/* Content */}
                ...
                {/* Item 4 */}
                <div className="col-span-3 md:col-span-5 relative lg:col-span-4 lg:row-span-1 row-span-2 bg-[#A90906]/20 backdrop-blur-md rounded-3xl border border-white/20">
                    {/* Content */}
                    <div className='absolute bottom-4 right-4 flex items-end'>
                        <div className='max-w-sm text-white text-end uppercase'>
                            <h3 className='text-lg md:text-xl lg:text-4xl font-bold leading-4'>Sticker<br/><span className='text-base'>Bundle</span></h3>
                        </div>
                    </div>
                </div>

                {/* Item 5 */}
                <div className="col-span-3 relative md:col-span-5 lg:col-span-6 row-span-2 h-full flex items-center lg:row-span-1 bg-[#E1C9B0]/20 backdrop-blur-md rounded-3xl border border-white/20">
            ...
            <div className="flex flex-row text-white items-center gap-4">
                ...
                <span className="font-bold text-[3.8rem] md:text-[5rem] leading-none tracking-tighter">
                    2025
                </span>
            </div>
      </div>
