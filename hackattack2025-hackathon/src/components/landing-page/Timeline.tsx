  ...
  const timelineData = [
    {
      ...
      description: "Start your journey here! The first wave of registration is open for early applicants who are ready to take on the challenge.",
    ...
    },
    {
      ...
      description: "Missed the first batch? Don’t worry — secure your spot in the second registration window before it closes!",
    ...
    },
    {
      ...
      description: "Join us for a mandatory technical meeting where we’ll walk you through the competition rules, submission guidelines, and judging criteria. Ask questions, meet other participants, and get fully prepared.",
      date: "8 November",
      category: "Analytics",
    ...
    },
    {
      ...
      description: "Submit your team’s project proposal and showcase your initial ideas. Make it count — this is your first step to reaching the final!",
      date: "11 November",
      category: "Growth",
    ...
    },
    {
      ...
      description: "We’ll reveal the selected teams who made it to the finals! Check your inbox and prepare for the next stage.",
      date: "21 November",
      category: "Growth",
      icon: <MapPin className="w-5 h-5" />,
      status: "upcoming"
    },
    {
      ...
      description: "Finalist teams will join an exclusive session to discuss final-stage details, judging formats, and presentation flow.",
      date: "29 November",
      category: "Growth",
      icon: <MapPin className="w-5 h-5" />,
      status: "upcoming"
    },
    {
      ...
      description: "It’s time to bring your ideas to life! Develop, test, and polish your final project during this intensive day of innovation.",
      date: "6 December",
      category: "Growth",
      icon: <MapPin className="w-5 h-5" />,
      status: "upcoming"
    },
    {
      ...
      description: "Present your solution to the panel of judges. Highlight your creativity, teamwork, and impact in front of experts and fellow participants.",
      date: "7 December",
      category: "Growth",
      icon: <MapPin className="w-5 h-5" />,
      status: "upcoming"
    },
    {
      ...
      description: "The moment you've been waiting for — celebrate your hard work and see which teams will take home the grand prize!",
      date: "7 December",
      category: "Growth",
      icon: <MapPin className="w-5 h-5" />,
      status: "upcoming"
                    ...
                    <div className="w-5/12 pl-8">
                      <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 border-none bg-white/5 text-white">
                        ...
                        <CardContent className="pt-0">
                          ...
                          <Badge className={`${getStatusColor(item.status)} capitalize font-medium`}>
                            {item.status.replace('-', ' ')}
                          </Badge>
                        </CardContent>
                      </Card>
