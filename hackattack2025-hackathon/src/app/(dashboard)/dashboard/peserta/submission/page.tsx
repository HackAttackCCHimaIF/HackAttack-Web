...
const SubmissionPage = () => {
  ...
  return (
    <div className="min-h-screen h-full flex flex-col">
        ...
        <div className="flex-1 w-full overflow-y-auto px-4 pb-8">
            <Card className="bg-white/10 backdrop-blur-md border-3 border-white/10 w-full text-white rounded-2xl flex flex-col h-full">
            <CardHeader className="py-12">
                <CardTitle className="text-2xl font-medium leading-none">
                <p>Halo, Team <span className='font-bold'>JuaraHackAttack 2025</span></p>
                <span className=" text-lg">Submit your proposal here!</span>
                </CardTitle>
            </CardHeader>
