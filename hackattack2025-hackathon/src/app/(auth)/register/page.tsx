    ...
    <div className="flex h-screen">
      <div className="w-full lg:w-3/5 flex flex-col justify-center items-center bg-white p-6 relative">
        ...
        <Card className="w-full max-w-md border shadow-xl rounded-4xl">
          <CardHeader>
            <CardTitle className="text-center text-5xl font-semibold py-6">Register</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4 ">
            ...
            <div className="w-full flex items-center justify-end">
                <Button className=" bg-[#4C82CB] hover:bg-[#4C82CB]/90 text-white z-10">Register</Button>
            </div>
          </CardContent>
        </Card>
        <Image
